...
cat('<h2 style="font-size:24px;">Validation Reports: Aspire</h2>\n')

check_list[["aspire"]]$agent

cat("\n\n")


cat('<h2 style="font-size:24px;">Validation Reports: EFI Data 360</h2>\n')

check_list[["d360_efi_data"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: Debt Transparency</h2>\n')

check_list[["debt_transparency"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: EPL</h2>\n')

check_list[["epl"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: Fraser</h2>\n')

check_list[["fraser"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: GFDB</h2>\n')

check_list[["gfdb"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: Heritage</h2>\n')

check_list[["heritage"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: PEFA Assessments</h2>\n')

check_list[["pefa_assessments"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: PMR</h2>\n')

check_list[["pmr"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: Romelli</h2>\n')

check_list[["romelli"]]$agent

cat("\n\n")

cat('<h2 style="font-size:24px;">Validation Reports: VDEM</h2>\n')

check_list[["vdem_data"]]$agent
