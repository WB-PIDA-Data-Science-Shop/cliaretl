...
static_clean <- readRDS(
  here("data-raw/output/static_ctf_pre_quality_2024.rds")
)

dynamic_clean <- readRDS(
  here("data-raw/output/dynamic_ctf_pre_quality_2024.rds")
)
...
# 1. For each country, select the latest available year (2020-2024)
